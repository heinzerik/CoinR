...
public static class CryptoCurrencyService
{
    ...
    static CryptoCurrencyService()
    {
        ...
        {
            new CryptoCurrency {chart=new List<string>{"100","20","30","40"},logo = new Image("img/btc.png"),name = "Bitcoin",rating = Rating.buy, symbol = "BTC",detailslink = "Bitcoin",chartname = "chart"},
            ...
            new CryptoCurrency {chart=new List<string>{"30","20","40","40"},logo = new Image("img/ltc.png"),name = "Litecoin",rating = Rating.buy, symbol = "LTC",detailslink = "Litecoin",chartname = "chart"},
        };
    }
